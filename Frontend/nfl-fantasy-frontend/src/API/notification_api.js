export const fetchNotifications = async (username) => {
    ...
    const response = await fetch(
        `${process.env.REACT_APP_SPRING_URL}/api/v1/notifications/getByUsername?username=${username}`, {
            method: "GET"
        }
    );
...
export const createNotification = async (username, message) => {
    ...
    const response = await fetch(
        `${process.env.REACT_APP_SPRING_URL}/api/v1/notifications/create?username=${username}&message=${message}`, {
            method: "POST",
            headers: {
...
export const deleteNotification = async (notifId) => {
    ...
    const response = await fetch(
        `${process.env.REACT_APP_SPRING_URL}/api/v1/notifications/delete?notif_id=${notifId}`, {
            method: "DELETE"
        }
    );
...
export const deleteAllNotifications = async (username) => {
    ...
    const response = await fetch(
        `${process.env.REACT_APP_SPRING_URL}/api/v1/notifications/deleteAll?username=${username}`, {
            method: "DELETE"
        }
    );
...
export const deleteOldNotifications = async (username) => {
    ...
    const response = await fetch(
        `${process.env.REACT_APP_SPRING_URL}/api/v1/notifications/deleteOld?username=${username}`, {
            method: "DELETE"
        }
    );
