export const updateMatchupsForPredictions = async (matchups, spreads, overUnders) => {
    /**
...
export const deleteOldMatchups = async (currentPredictionWeek) => {
    ...
    */ 
    ...
    const response = await fetch(`${process.env.REACT_APP_SPRING_URL}/api/v1/predictions/deleteOldMatchups?currentWeek=${currentPredictionWeek}`, {
        method: "DELETE"
    });
...
export const getPredictions = async (username) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_SPRING_URL}/api/v1/predictions/getPredictions?username=${username}`, {
        method: "GET"
    });
...
export const updatePredictedWinner = async (gameId, username, winner) => {
    ...
    const response = await fetch(
        `${process.env.REACT_APP_SPRING_URL}/api/v1/predictions/updatePredictedWinner?gameId=${gameId}&username=${username}&winner=${winner}`, 
    {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json"
...
export const updatePredictedSpread = async (gameId, username, spread) => {
    ...
    const response = await fetch(
        `${process.env.REACT_APP_SPRING_URL}/api/v1/predictions/updatePredictedSpread?gameId=${gameId}&username=${username}&spread=${spread}`, 
    {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json"
...
export const updatePredictedOverUnder = async (gameId, username, overUnder) => {
    ...
    const response = await fetch(
        `${process.env.REACT_APP_SPRING_URL}/api/v1/predictions/updatePredictedOverUnder?gameId=${gameId}&username=${username}&overUnder=${overUnder}`, 
    {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json"
